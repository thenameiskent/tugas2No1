...
class _LuasSegitigaCalculatorState extends State<LuasSegitigaCalculator> { 
  TextEditingController alasController = TextEditingController();   TextEditingController tinggiController = TextEditingController();   double luas = 0.0; 
 
  void hitungLuas() { 
    double alas = double.tryParse(alasController.text) ?? 0.0;     double tinggi = double.tryParse(tinggiController.text) ?? 0.0; 
    ...
    return Scaffold(       appBar: AppBar( 
      ...
      body: Padding( 
        padding: EdgeInsets.all(16.0),         child: Column( 
          mainAxisAlignment: MainAxisAlignment.center,           children: <Widget>[             TextField( 
            ...
            SizedBox(height: 16.0),             ElevatedButton(               onPressed: hitungLuas, 
